...
class WireGuardConfig(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='wireguard_configs')
...
class DropboxSettings(models.Model):
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name='dropbox_settings')
...
class XrayConfig(models.Model):
    ...
    shadowsocks_method = models.CharField(max_length=50, default="chacha20-ietf-poly1305")
